                                            ...
                                            <tr class="prod-color-tr">
                                                ...
                                                <td>
                                                    <div class="input-group mb-3" style="width: 150px;">
                                                        <input type="text" value="{{ $prodColor->colorquantity }}" class="productColorQuantity form-control form-control-sm"/>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.updateProductColorBtn', function(){
            ...
            $.ajax({
                type: "POST",
                url: "/admin/products-color/"+prod_color_id,
                data: data,
        ...
        $(document).on('click', '.deleteProductColorBtn', function(){
            ...
            $.ajax({
                type: "GET",
                url: "/admin/products-color/"+prod_color_id+"/delete",
                success: function (response) {
