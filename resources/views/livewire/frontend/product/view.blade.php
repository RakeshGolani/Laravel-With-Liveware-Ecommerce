                        ...
                        <div>
                            @if($product->productColors->count() > 0)
                                ...
                                @foreach($product->productColors as $colorItem)
                                    ...
                                    <label class="colorSelectionLabele text-white" style="background-color: {{ $colorItem->color->code }}"
                            ...
                            <div class="item mb-3">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        ...
                                        <img src="{{ asset($relatedProductItem->productImages[0]->image) }}" class="img-fluid" alt="{{ $relatedProductItem->name }}">
                                        </a>
                                        @endif
                                    </div>
