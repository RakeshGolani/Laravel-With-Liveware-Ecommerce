    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <h4>Welcome to Laravel of Web IT E-Commerce</h4>
...
<div class="py-5 bg-white">
    <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h4>New Arrivals</h4>
            <a href="{{ url('new-arrivals') }}" class="btn btn-warning float-end mb-3">View More</a>
            <div class="underline mb-4"></div>
          </div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="{{ url('featured-products') }}" class="btn btn-warning float-end mb-3">View More</a>
            <div class="underline mb-4"></div>
          </div>
          @if($featuredProducts)
            <div class="col-md-12">
